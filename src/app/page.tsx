    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 min-h-screen  font-sans">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Link href="/stock" className="group p-6 bg-white dark:bg-slate-950 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-800 hover:border-emerald-500/50 dark:hover:border-emerald-500/50 transition-all flex flex-col gap-4">
            ...
            <div>
                <span className="block font-semibold text-zinc-900 dark:text-white group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">Stock</span>
                <span className="text-sm text-zinc-500">Vue inventaire</span>
            </div>
          </Link>

          <Link href="/mouvements/nouveau" className="group p-6 bg-white dark:bg-slate-950 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-800 hover:border-purple-500/50 dark:hover:border-purple-500/50 transition-all flex flex-col gap-4">
            ...
            <div>
                <span className="block font-semibold text-zinc-900 dark:text-white group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">Mouvements</span>
                <span className="text-sm text-zinc-500">Entrée / Sortie rapide</span>
            </div>
          </Link>
