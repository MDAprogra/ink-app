      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-fg mt-1">
            Historique global des entrées et sorties de stock.
          </p>
        </div>
        <Link
          href="/catalogue"
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-border">
            <thead className="bg-muted/50">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-medium text-muted-fg uppercase tracking-wider">
                  Date & Heure
                </th>
                <th className="px-6 py-3 text-left text-xs font-medium text-muted-fg uppercase tracking-wider">
                  Article
                ...
                <th className="px-6 py-3 text-right text-xs font-medium text-muted-fg uppercase tracking-wider">
                  Actions
                </th>
              </tr>
            </thead>
            <tbody className="bg-white dark:bg-slate-950 divide-y divide-border">
              {mouvements.length === 0 ? (
                <tr>
                  <td
                    colSpan={6}
                    className="px-6 py-10 text-center text-muted-fg"
                  >
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-muted-fg">
                        ...
                        <div className="text-xs">
                          {new Date(mvt.date).toLocaleTimeString("fr-FR", {
                            hour: "2-digit",
                            minute: "2-digit",
                          })}
                        </div>
                      ...
                      <td className="px-6 py-4">
                        ...
                        <div className="text-xs text-muted-fg">
                          Ref: {produit.referenceInterfas || "N/A"}
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        >
                          {isEntree ? "+" : "-"}
                          {Number(mvt.quantite)} {produit.uniteGestion}
                        </span>
                      </td>
